    ...
    <>
      ...
      <section className="mt-20 px-4 sm:px-6 ">
        <TitleSection
          ...
          pill="Pricing"
        />
        <div className="flex flex-col-reverse sm:flex-row justify-center gap-4 sm:items-stretch items-center mt-10">
            ...
            <CustomCard
              ...
              cardContent={
                <CardContent className="p-0">
                  ...
                  <p className="dark:text-washed-purple-800 ml-1">{card.description}</p>

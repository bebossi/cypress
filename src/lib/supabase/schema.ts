...
export const subscriptions = pgTable('subscriptions', {
  ...
  currentPeriodEnd: timestamp('current_period_end', {
    ...
    .default(sql`now()`)
    .notNull(),
  endedAt: timestamp('ended_at', { withTimezone: true, mode: 'string' }).default(
    sql`now()`
  ),
  cancelAt: timestamp('cancel_at', { withTimezone: true, mode: 'string' }).default(
    sql`now()`
  ),
  ...
  trialEnd: timestamp('trial_end', { withTimezone: true, mode: 'string' }).default(
    sql`now()`
  ),
})
